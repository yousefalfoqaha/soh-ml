...
OXFORD_MCUS = [f"cell{i}" for i in range(1, OXFORD_N_MCUS + 1)]
...
FT_MAX_LEARNING_RATE = 0.0001
FT_MIN_LEARNING_RATE = 0.000001
OXFORD_TRAINING_PERCENTAGE = 0.15
OXFORD_VALIDATION_PERCENTAGE = 0.05
