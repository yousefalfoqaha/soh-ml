...
\subsection{Dataset}
The dataset was obtained from the Scienlab SL1007A charge-discharge testing platform, where eight Samsung INR21700-50E LiBs were cycled from fresh SoH levels to beyond end-of-life \cite{scienlab_sl1007a}.
Telemetry of each cell was recorded using Measurement and Control Units (MCU) and exported as ASAM Measurement Data Format (MF4) files \cite{asam_mdf4} using \texttt{asammdf} \cite{asammdf}.
Cell specifications are given in Table \ref{tab:cell_specs}.
